...
namespace ProjectD.Player.Input
{
    ...
    ""controlSchemes"": []
            ...
            // OpenArea
            m_OpenArea = asset.FindActionMap("OpenArea", true);
            m_OpenArea_Movement = m_OpenArea.FindAction("Movement", true);
            m_OpenArea_Interact = m_OpenArea.FindAction("Interact", true);
        }
        ...
        public struct OpenAreaActions
        {
            ...
            public static implicit operator InputActionMap(OpenAreaActions set)
            {
                return set.Get();
            }
